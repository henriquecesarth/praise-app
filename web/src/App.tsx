...
import { Search, SlidersHorizontal, Plus, CheckCircle, XCircle } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="app-container">
      ...
      {/* Main Brand & Upper Tabs Navigation */}
      {!selectedSong && !selectedFolder && (
        <header className="app-header">
          <div className="brand-section">
            <div>
              <h1 className="brand-title">🎵 Praise</h1>
              <span className="brand-subtitle">Gestão de Ministérios de Louvor</span>
            </div>
          </div>
